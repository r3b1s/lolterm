...
## Purpose
Provide an optional module for installing AI/LLM CLI tooling on Fedora 44 systems. Currently installs Claude Code from the Anthropic signed DNF repository. The module is designed to be the common home for future AI tooling flags, with `install/ai.sh` serving as the single entry point.
